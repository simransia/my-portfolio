...
const ContactForm = () => {
  ...
  return (
    <section className="relative text-white p-5 lg:w-10/12 mx-auto flex lg:flex-row flex-col max-container">
      ...
      <div className="lg:w-1/2 relative w-full lg:h-auto md:h-[550px] h-[350px]">
        <Canvas>
          {" "}
        ...
        <div className="absolute left-1/2 -translate-x-1/2 bottom-10 flex gap-6">
          <Link
            target="_blank"
          ...
          <Link target="_blank" href={"https://github.com/simransia"}>
            <svg
              className="h-6 w-6 text-white"
              viewBox="0 0 24 24"
              fill="none"
